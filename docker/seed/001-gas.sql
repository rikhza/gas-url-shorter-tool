...
(NULL, 'https://github.com/rikhza/gas-url-shorter', 'Powered by GAS Open Source', '', '', 'external', 'bottom', 1, 0, NOW(), NOW()),
(NULL, 'https://github.com/rikhza/gas-url-shorter', 'Built with GAS Open Source', '', '', 'external', 'bottom', 0, 0, NOW(), NOW());
...
VALUES
('main', '{"title":"GAS Link Intelligence","default_language":"english","default_theme_style":"light","default_timezone":"UTC","index_url":"","terms_and_conditions_url":"","privacy_policy_url":"","not_found_url":"","se_indexing":true,"display_index_plans":false,"default_results_per_page":25,"default_order_type":"DESC","auto_language_detection_is_enabled":true,"blog_is_enabled":true,"api_is_enabled":true,"logo_light":"","logo_dark":"","logo_email":"","opengraph":"","favicon":""}'),
...
('payment', '{\"is_enabled\":\"0\",\"type\":\"both\",\"brand_name\":\"GAS\",\"currency\":\"USD\", \"codes_is_enabled\": false}'),
