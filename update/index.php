...
<div class="container">
    <header class="card header mt-4">
        <div class="card-body d-flex">
            <div class="mr-3">
                <img src="./assets/images/logo.png" class="img-fluid logo" alt="GAS Open Source logo" />
            </div>
            ...
            <div class="d-flex flex-column justify-content-center">
                ...
                <p class="subheader d-flex flex-row">
                    <span class="text-muted">
                        <a href="<?= PRODUCT_URL ?>" target="_blank" class="text-gray-500"><?= PRODUCT_NAME ?></a> by <a href="https://altumco.de/site" target="_blank" class="text-gray-500">GAS Open Source</a>
                    </span>
                </p>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <section id="welcome" style="display: none">
                            ...
                            <p>Thank you for choosing the <a href="https://altumco.de/site" target="_blank">GAS Open Source</a> brand 🤗.</p>
