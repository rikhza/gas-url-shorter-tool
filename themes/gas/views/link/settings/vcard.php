...
<div class="card">
    <div class="card-body">
        ...
        <form name="update_vcard" action="" method="post" role="form">
            ...
            <div class="form-group">
                <label for="<?= 'vcard_avatar_' . $data->link->link_id ?>"><i class="fas fa-fw fa-image fa-sm text-muted mr-1"></i> <?= l('create_biolink_vcard_modal.vcard_avatar') ?></label>
                    ...
                    <?php foreach($data->link->settings->vcard_phone_numbers ?? [] as $key => $phone_number): ?>
                        <div class="mb-4">
                            <div class="form-group">
                                ...
                                <input id="<?= 'vcard_phone_number_' . $key . '_' . $data->link->link_id ?>" type="text" name="vcard_phone_numbers[<?= $key ?>]" value="<?= $phone_number ?>" class="form-control" maxlength="<?= $data->link_types['vcard']['fields']['phone_number']['max_length'] ?>" required="required" />
                            </div>
...
<template id="template_vcard_phone_numbers">
    <div class="mb-4">
        <div class="form-group">
            ...
            <input id="" type="text" name="vcard_phone_numbers[]" class="form-control" maxlength="<?= $data->link_types['vcard']['fields']['phone_number']['max_length'] ?>" required="required" />
        </div>
