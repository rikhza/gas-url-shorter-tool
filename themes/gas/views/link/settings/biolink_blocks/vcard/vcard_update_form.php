                ...
                <?php foreach($row->settings->vcard_phone_numbers ?? [] as $key => $phone_number): ?>
                    <div class="mb-4">
                        <div class="form-group">
                            ...
                            <input id="<?= 'vcard_phone_number_' . $key . '_' . $row->biolink_block_id ?>" type="text" name="vcard_phone_numbers[<?= $key ?>]" value="<?= $phone_number ?>" class="form-control" maxlength="<?= $data->biolink_blocks['vcard']['fields']['phone_number']['max_length'] ?>" required="required" />
                        </div>
