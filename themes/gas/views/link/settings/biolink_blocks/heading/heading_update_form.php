    ...
    <div class="collapse" id="verified_container">
        ...
        <div <?= $data->link->is_verified ? null : 'data-toggle="tooltip" title="' . l('global.info_message.plan_feature_no_access') . '"' ?>>
            <div class="<?= $data->link->is_verified ? null : 'container-disabled' ?>">
                <div class="form-group">
                    <label for="<?= 'link_verified_location_' . $row->biolink_block_id ?>"><?= l('link.settings.verified_location') ?></label>
                    <select id="<?= 'link_verified_location_' . $row->biolink_block_id ?>" name="verified_location" class="custom-select">
                        <option value="" <?= $row->settings->verified_location == '' ? 'selected="selected"' : null?>><?= l('global.none') ?></option>
                        <option value="right" <?= $row->settings->verified_location == 'right' ? 'selected="selected"' : null?>><?= l('link.settings.verified_location_right') ?></option>
                        <option value="left" <?= $row->settings->verified_location == 'left' ? 'selected="selected"' : null?>><?= l('link.settings.verified_location_left') ?></option>
                    </select>
                </div>
            </div>
        </div>
