...
<form name="update_biolink_" method="post" role="form">
    ...
    <button class="btn btn-block btn-gray-300 my-4" type="button" data-toggle="collapse" data-target="#<?= 'email_collector_settings_container_' . $row->biolink_block_id ?>" aria-expanded="false" aria-controls="<?= 'email_collector_settings_container_' . $row->biolink_block_id ?>">
        <?= l('create_biolink_email_collector_modal.email_collector_header') ?>
    </button>
    ...
    <div class="collapse" id="<?= 'email_collector_settings_container_' . $row->biolink_block_id ?>">
        ...
        <div class="form-group">
            ...
            <input id="<?= 'email_collector_thank_you_url_' . $row->biolink_block_id ?>" type="url" name="thank_you_url" class="form-control" value="<?= $row->settings->thank_you_url ?>" maxlength="2048" />
        </div>
        ...
        <div class="form-group">
            ...
            <input id="<?= 'email_collector_agreement_url_' . $row->biolink_block_id ?>" type="text" name="agreement_url" class="form-control" value="<?= $row->settings->agreement_url ?>" maxlength="2048" />
        </div>
    </div>
    ...
    <div class="collapse" id="<?= 'email_collector_data_container_' . $row->biolink_block_id ?>">
        ...
        <div class="form-group">
            ...
            <input id="<?= 'email_collector_webhook_url_' . $row->biolink_block_id ?>" type="text" name="webhook_url" class="form-control" value="<?= $row->settings->webhook_url ?>" maxlength="2048" />
        ...
        <div class="form-group">
            ...
            <div data-image-container="image" class="<?= !empty($row->settings->image) ? null : 'd-none' ?>">
                ...
                <div class="custom-control custom-checkbox my-2">
                    <input id="<?= $row->biolink_block_id . '_image_remove' ?>" name="image_remove" type="checkbox" class="custom-control-input" onchange="this.checked ? document.querySelector('#<?= 'email_collector_image_' . $row->biolink_block_id ?>').classList.add('d-none') : document.querySelector('#<?= 'email_collector_image_' . $row->biolink_block_id ?>').classList.remove('d-none')">
                    <label class="custom-control-label" for="<?= $row->biolink_block_id . '_image_remove' ?>">
                        <span class="text-muted"><?= l('global.delete_file') ?></span>
                    </label>
                </div>
            </div>
            <input id="<?= 'email_collector_image_' . $row->biolink_block_id ?>" type="file" name="image" accept="<?= Altum\Uploads::array_to_list_format($data->biolink_blocks['email_collector']['whitelisted_thumbnail_image_extensions']) ?>" class="form-control-file altum-file-input" />
