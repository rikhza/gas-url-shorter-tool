            ...
            <div class="modal-body">
                <form name="create_biolink_file" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label for="file_file"><i class="fas fa-fw fa-file fa-sm text-muted mr-1"></i> <?= l('create_biolink_file_modal.file') ?></label>
                    ...
                    <div class="form-group">
                        <label for="file_name"><i class="fas fa-fw fa-signature fa-sm text-muted mr-1"></i> <?= l('create_biolink_link_modal.input.name') ?></label>
