            ...
            <div class="modal-body">
                <form name="create_biolink_big_link" method="post" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <input id="big_link_location_url" type="text" class="form-control" name="location_url" required="required" maxlength="2048" placeholder="<?= l('create_biolink_link_modal.input.location_url_placeholder') ?>" />
                    </div>
