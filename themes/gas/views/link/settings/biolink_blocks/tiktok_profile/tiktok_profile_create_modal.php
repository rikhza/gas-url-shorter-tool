            ...
            <div class="modal-body">
                <form name="create_biolink_tiktok_profile" method="post" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <input id="tiktok_profile_location_url" type="text" class="form-control" name="location_url" required="required" maxlength="2048" placeholder="<?= l('create_biolink_tiktok_profile_modal.location_url_placeholder') ?>" />
                    </div>
