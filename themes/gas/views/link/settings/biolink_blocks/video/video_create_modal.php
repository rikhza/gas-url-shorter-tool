            ...
            <div class="modal-body">
                <form name="create_biolink_video" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="video_file"><i class="fas fa-fw fa-video fa-sm text-muted mr-1"></i> <?= l('create_biolink_video_modal.file') ?></label>
                    ...
                    <div class="form-group">
                        <label for="video_poster_url"><i class="fas fa-fw fa-image fa-sm text-muted mr-1"></i> <?= l('create_biolink_video_modal.poster_url') ?></label>
                        <input id="video_poster_url" type="url" name="poster_url" maxlength="2048" class="form-control" />
                    </div>

                    <div class="form-group">
                        <label for="video_name"><i class="fas fa-fw fa-signature fa-sm text-muted mr-1"></i> <?= l('create_biolink_link_modal.input.name') ?></label>
