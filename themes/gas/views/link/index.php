            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a href="<?= url('qr-code-create?name=' . $data->link->url . '&project_id=' . $data->link->project_id . '&type=url&url=' . $data->link->full_url) ?>" class="dropdown-item" rel="noreferrer"><i class="fas fa-fw fa-sm fa-qrcode mr-2"></i> <?= l('qr_codes.link') ?></a>
                        <?php endif ?>
