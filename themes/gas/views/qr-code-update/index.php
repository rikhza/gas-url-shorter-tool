                ...
                <div class="card-body">
                    <form action="" method="post" role="form" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="name"><i class="fas fa-fw fa-signature fa-sm text-muted mr-1"></i> <?= l('qr_codes.input.name') ?></label>
                        ...
                        <div class="form-group">
                            <div class="d-flex flex-column flex-xl-row justify-content-between">
                                ...
                                <a href="<?= url('projects') ?>" target="_blank" class="small mb-2"><i class="fas fa-fw fa-sm fa-plus mr-1"></i> <?= l('projects.create') ?></a>
                            </div>
                        ...
                        <div>
                            <div class="form-group" data-type="url">
                                <label for="url"><i class="fas fa-fw fa-link fa-sm text-muted mr-1"></i> <?= l('qr_codes.input.url') ?></label>
                                    ...
                                    <?php foreach($data->qr_code->settings->vcard_phone_numbers ?? [] as $key => $phone_number): ?>
                                        <div class="mb-4">
                                            <div class="form-group">
                                                ...
                                                <input id="<?= 'vcard_phone_number_' . $key ?>" type="text" name="vcard_phone_numbers[<?= $key ?>]" value="<?= $phone_number ?>" class="form-control" maxlength="<?= $data->qr_code_settings['type']['vcard']['phone_number']['max_length'] ?>" required="required" data-reload-qr-code />
                                            </div>
...
<template id="template_vcard_phone_numbers">
    <div class="mb-4">
        <div class="form-group">
            ...
            <input id="" type="text" name="vcard_phone_numbers[]" class="form-control" maxlength="<?= $data->qr_code_settings['type']['vcard']['phone_number']['max_length'] ?>" required="required" data-reload-qr-code />
        </div>
