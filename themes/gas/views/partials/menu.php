...
<nav id="navbar" class="navbar navbar-main navbar-expand-lg navbar-light mb-6 <?= \Altum\Router::$controller_key == 'index' ? 'index-highly-rounded border border-gray-100 mt-4' : null ?>">
    <div class="container">
        <a
            class="navbar-brand"
            href="<?= url() ?>"
