            ...
            <div class="modal-body">
                <div class="d-flex justify-content-between mb-3">
                    <h5 class="modal-title">
                        <i class="fas fa-fw fa-sm fa-share-alt text-primary-900 mr-2"></i>
                        <?= l('global.share') ?>
                    </h5>
                ...
                <div class="d-flex align-items-center justify-content-between flex-wrap my-3">
                    <a href="mailto:?body=%s" target="_blank" class="btn btn-gray-100 mb-2">
                        <i class="fas fa-fw fa-envelope"></i>
                    </a>
                    <a href="https://www.facebook.com/sharer/sharer.php?u=%s" target="_blank" class="btn btn-gray-100 mb-2">
                        <i class="fab fa-fw fa-facebook"></i>
                    </a>
                    <a href="https://twitter.com/share?url=%s" target="_blank" class="btn btn-gray-100 mb-2">
                        <i class="fab fa-fw fa-twitter"></i>
                    </a>
                    <a href="https://pinterest.com/pin/create/link/?url=%s" target="_blank" class="btn btn-gray-100 mb-2">
                        <i class="fab fa-fw fa-pinterest"></i>
                    </a>
                    <a href="https://linkedin.com/shareArticle?url=%s" target="_blank" class="btn btn-gray-100 mb-2">
                        <i class="fab fa-fw fa-linkedin"></i>
                    </a>
                    <a href="https://www.reddit.com/submit?url=%s" target="_blank" class="btn btn-gray-100 mb-2">
                        <i class="fab fa-fw fa-reddit"></i>
                    </a>
                    <a href="https://wa.me/?text=%s" class="btn btn-gray-100 mb-2">
