...
<ul class="list-style-none m-0">
    ...
    <li class="d-flex align-items-baseline mb-2">
        ...
        <div class="<?= $no_forced_splash_page ? null : 'text-muted' ?>">
            ...
            <span class="mr-1" data-toggle="tooltip" title="<?= l('global.plan_settings.no_forced_splash_page_help') ?>"><i class="fas fa-fw fa-xs fa-question-circle text-gray-500"></i></span>
        </div>
    </li>
    <?php endif ?>
    ...
    <?php foreach(require APP_PATH . 'includes/simple_user_plan_settings.php' as $row): ?>
        <li class="d-flex align-items-baseline mb-2">
            ...
            <div class="<?= $data->plan_settings->{$row} ? null : 'text-muted' ?>">
                ...
                <span class="mr-1" data-toggle="tooltip" title="<?= l('global.plan_settings.' . $row . '_help') ?>"><i class="fas fa-fw fa-xs fa-question-circle text-gray-500"></i></span>
            </div>
        </li>
    <?php endforeach ?>
</ul>
