    ...
    <div class="row mb-4">
        ...
        <div class="col-12 col-xl-auto d-flex">
            <div>
                ...
                <?php else: ?>
                    <a href="<?= url('team-create') ?>" class="btn btn-outline-primary" data-toggle="tooltip" data-html="true" title="<?= get_plan_feature_limit_info($data->total_teams, $this->user->plan_settings->teams_limit) ?>">
                        <i class="fas fa-fw fa-plus-circle fa-sm mr-1"></i> <?= l('teams.create') ?>
                    </a>
                <?php endif ?>
            </div>
