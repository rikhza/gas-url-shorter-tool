    ...
    <div class="card-body">
        <form action="" method="post" role="form">
            ...
            <div class="form-group">
                <label for="type"><i class="fas fa-fw fa-fingerprint fa-sm text-muted mr-1"></i> <?= l('admin_resources.main.type') ?></label>
            ...
            <div class="form-group" data-type="internal">
                <label for="description"><i class="fas fa-fw fa-sm fa-pen text-muted mr-1"></i> <?= l('admin_resources.main.description') ?></label>
            ...
            <div class="collapse" id="advanced_container">
                ...
                <div class="form-group">
                    <label for="language"><i class="fas fa-fw fa-sm fa-language text-muted mr-1"></i> <?= l('admin_resources.main.language') ?></label>
