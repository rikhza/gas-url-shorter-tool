                    ...
                    <form action="" method="get" role="form">
                        ...
                        <div class="form-group px-4">
                            ...
                            <select name="api" id="filters_api" class="custom-select custom-select-sm">
                                <option value=""><?= l('global.all') ?></option>
                                <option value="openai_dall_e" <?= isset($data->filters->filters['api']) && $data->filters->filters['api'] == 'openai_dall_e' ? 'selected="selected"' : null ?>>OpenAI - DALL E</option>
                                <option value="clipdrop" <?= isset($data->filters->filters['api']) && $data->filters->filters['api'] == 'clipdrop' ? 'selected="selected"' : null ?>>ClipDrop - StableDiffusion</option>
                            </select>
                        </div>
    ...
    <div class="table-responsive table-custom-container">
        <table class="table table-custom">
            ...
            <?php foreach($data->images as $row): ?>
                <?php //GAS:DEMO if(DEMO) {$row->user_email = 'hidden@demo.com'; $row->user_name = $row->name = 'hidden on demo';} ?>
