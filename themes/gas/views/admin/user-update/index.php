...
<?php //GAS:DEMO if(DEMO) {$data->user->email = 'hidden@demo.com'; $data->user->name = $data->user->ip = 'hidden on demo';} ?>
...
<div class="card <?= \Altum\Alerts::has_field_errors() ? 'border-danger' : null ?>">
    <div class="card-body">
        ...
        <form action="" method="post" role="form" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="name"><i class="fas fa-fw fa-sm fa-signature text-muted mr-1"></i> <?= l('admin_users.main.name') ?></label>
            ...
            <div class="form-group">
                <label for="email"><i class="fas fa-fw fa-sm fa-envelope text-muted mr-1"></i> <?= l('admin_users.main.email') ?></label>
            ...
            <div id="plan_settings" style="display: none">
                ...
                <div class="form-group" <?= !settings()->links->splash_page_is_enabled ? 'style="display: none"' : null ?>>
                ...
                <div class="form-group" <?= !settings()->links->qr_codes_is_enabled ? 'style="display: none"' : null ?>>
                ...
                <div class="form-group" <?= !settings()->links->biolinks_is_enabled ? 'style="display: none"' : null ?>>
                ...
                <?php if(\Altum\Plugin::is_active('aix')): ?>
                    ...
                    <div class="form-group">
                        ...
                        <select id="images_api" name="images_api" class="custom-select">
                            <option value="openai_dall_e" <?= $data->user->plan_settings->images_api == 'openai_dall_e' ? 'selected="selected"' : null ?>>OpenAI - DALL E (<?= l('global.plan_settings.images_api.openai_dall_e') ?>)</option>
                            <option value="clipdrop" <?= $data->user->plan_settings->images_api == 'clipdrop' ? 'selected="selected"' : null ?>>ClipDrop - StableDiffusion (<?= l('global.plan_settings.images_api.clipdrop') ?>)</option>
                        </select>
