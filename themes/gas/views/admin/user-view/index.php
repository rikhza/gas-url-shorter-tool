    ...
    <div class="col-xl-4 mb-4">
        <div class="card h-100">
            <div class="card-body">
                ...
                <div class="form-group">
                    <label for="email" class="font-weight-bold"><i class="fas fa-fw fa-sm fa-envelope text-muted mr-1"></i> <?= l('admin_users.main.email') ?></label>
                    <input id="email" type="text" class="form-control-plaintext" value="<?= $data->user->email ?>" readonly />
                </div>

                <div class="form-group">
                    <label for="name" class="font-weight-bold"><i class="fas fa-fw fa-sm fa-signature text-muted mr-1"></i> <?= l('admin_users.main.name') ?></label>
                    <input id="name" type="text" class="form-control-plaintext" value="<?= $data->user->name ?>" readonly />
                </div>

                <div class="form-group">
                    <label for="language" class="font-weight-bold"><i class="fas fa-fw fa-sm fa-language text-muted mr-1"></i> <?= l('admin_users.main.language') ?></label>
    ...
    <div class="col-xl-4 mb-4">
        <div class="card h-100">
            <div class="card-body">
                ...
                <div class="form-group">
                    <label for="last_user_agent" class="font-weight-bold"><i class="fas fa-fw fa-sm fa-desktop text-muted mr-1"></i> <?= l('admin_users.main.last_user_agent') ?></label>
...
<div class="my-5 row justify-content-between">
    ...
    <div class="col-12 col-sm-6 col-xl-3 mb-4 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            ...
            <div class="pr-4 d-flex flex-column justify-content-center">
                <a href="<?= url('admin/users?user_id=' . $data->user->user_id) ?>" class="stretched-link">
                    <i class="fas fa-fw fa-angle-right text-gray-500"></i>
                </a>
            </div>
        </div>
