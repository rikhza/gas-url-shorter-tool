...
<div>
    ...
    <div class="form-group">
        <label for="index_url"><i class="fas fa-fw fa-sm fa-sitemap text-muted mr-1"></i> <?= l('admin_settings.main.index_url') ?></label>
    ...
    <div class="form-group custom-control custom-switch">
        ...
        <label class="custom-control-label" for="se_indexing"><i class="fas fa-fw fa-sm fa-envelope text-muted mr-1"></i> <?= l('admin_settings.main.se_indexing') ?></label>
    </div>
