                        ...
                        <form action="" method="get" role="form">
                            ...
                            <div class="form-group px-4">
                                ...
                                <select name="search_by" id="filters_search_by" class="custom-select custom-select-sm">
                                    ...
                                    <option value="description" <?= $data->filters->search_by == 'description' ? 'selected="selected"' : null ?>><?= l('admin_internal_notifications.main.description') ?></option>
                                </select>
                            </div>
        ...
        <div class="table-responsive table-custom-container">
            <table class="table table-custom">
                ...
                <?php foreach($data->internal_notifications as $row): ?>
                    <?php //GAS:DEMO if(DEMO) {$row->user_email = 'hidden@demo.com'; $row->user_name = $row->ip = 'hidden on demo';} ?>
