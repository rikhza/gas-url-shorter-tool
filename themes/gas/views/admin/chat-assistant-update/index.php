    ...
    <div class="card-body">
        <form action="" method="post" role="form" enctype="multipart/form-data">
            ...
            <div class="collapses show" id="name_translate_container">
                <div class="p-3 bg-gray-50 rounded mb-4">
                    <?php foreach(\Altum\Language::$active_languages as $language_name => $language_code): ?>
                        ...
                        <div class="form-group">
                            <label for="<?= 'translation_' . $language_name . '_description' ?>"><i class="fas fa-fw fa-sm fa-pen text-muted mr-1"></i> <?= l('admin_chats_assistants.main.description') ?></label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><?= $language_name ?></span>
                                </div>
            ...
            <div class="form-group">
                ...
                <textarea id="prompt" name="prompt" class="form-control <?= \Altum\Alerts::has_field_errors('prompt') ? 'is-invalid' : null ?>" placeholder="<?= l('admin_chats_assistants.main.prompt_placeholder') ?>" maxlength="2048" required="required"><?= $data->chat_assistant->prompt ?></textarea>
            ...
            <div class="form-group">
                ...
                <?php if(!empty($data->chat_assistant->image)): ?>
                    <div class="m-1">
                        <img src="<?= \Altum\Uploads::get_full_url('chats_assistants') . $data->chat_assistant->image ?>" class="img-fluid" style="max-height: 2.5rem;height: 2.5rem;" />
                    </div>
                ...
                <?php endif ?>
                <input id="image" type="file" name="image" accept="<?= \Altum\Uploads::get_whitelisted_file_extensions_accept('chats_assistants') ?>" class="form-control-file altum-file-input" />
