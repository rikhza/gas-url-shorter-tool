...
<div class="card mb-5">
    <div class="card-body">
        <h2 class="h4 mb-4"><i class="fas fa-fw fa-globe-europe fa-xs text-primary-900"></i> <?= l('global.continents') ?></h2>
...
<div class="card mb-5">
    <div class="card-body">
        <h2 class="h4 mb-4"><i class="fas fa-fw fa-flag fa-xs text-primary-900"></i> <?= l('global.countries') ?></h2>
...
<div class="card mb-5">
    <div class="card-body">
        <h2 class="h4 mb-4"><i class="fas fa-fw fa-sign-in-alt fa-xs text-primary-900"></i> <?= l('admin_statistics.users.sources') ?></h2>
