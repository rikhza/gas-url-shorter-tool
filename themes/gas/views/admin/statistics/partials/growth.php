...
<div class="card mb-5">
    <div class="card-body">
        <h2 class="h4"><i class="fas fa-fw fa-users fa-xs text-primary-900"></i> <?= l('admin_statistics.growth.users.header') ?></h2>
...
<div class="card mb-5">
    <div class="card-body">
        <h2 class="h4"><i class="fas fa-fw fa-user-friends fa-xs text-primary-900"></i> <?= l('admin_statistics.growth.users_logs.header') ?></h2>
        <div class="d-flex flex-column flex-xl-row">
            <div class="mb-2 mb-xl-0 mr-4">
...
<?php if(in_array(settings()->license->type, ['Extended License', 'extended'])): ?>
    <div class="card mb-5">
        <div class="card-body">
            <h2 class="h4"><i class="fas fa-fw fa-tags fa-xs text-primary-900"></i> <?= l('admin_statistics.growth.redeemed_codes.header') ?></h2>
            <div class="d-flex flex-column flex-xl-row">
                <div class="mb-2 mb-xl-0 mr-4">
