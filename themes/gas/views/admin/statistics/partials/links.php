...
<div class="card mb-5">
    <div class="card-body">
        <h2 class="h4"><i class="fas fa-fw fa-link fa-xs text-primary-900"></i> <?= l('admin_statistics.links.shortened_links.header') ?></h2>
...
<div class="card mb-5">
    <div class="card-body">
        <h2 class="h4"><i class="fas fa-fw fa-hashtag fa-xs text-primary-900"></i> <?= l('admin_statistics.links.biolink_links.header') ?></h2>
        <div class="d-flex flex-column flex-xl-row">
            <div class="mb-2 mb-xl-0 mr-4">
