...
class ImageCreate extends Controller {
    ...
    public function create_ajax() {
        //GAS:DEMO if(DEMO) if($this->user->user_id == 1) Response::json('Please create an account on the demo to test out this function.', 'error');
        ...
        if(settings()->aix->input_moderation_is_enabled) {
            try {
                $response = \Unirest\Request::post(
                    ...
                    [
                        'Authorization' => 'Bearer '  . get_random_line_from_text(settings()->aix->openai_api_key),
        ...
        $this->user->plan_settings->images_api = $this->user->plan_settings->images_api ?? 'openai_dall_e';
            ...
            case 'clipdrop':
                ...
                try {
                    $response = \Unirest\Request::post(
                        ...
                        [
                            'x-api-key' => get_random_line_from_text(settings()->aix->clipdrop_api_key),
                        ],
