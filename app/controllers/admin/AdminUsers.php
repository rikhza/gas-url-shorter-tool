...
class AdminUsers extends Controller {
    ...
    public function index() {
        ...
        $filters = (new \Altum\Filters(['status', 'source', 'plan_id', 'country', 'continent_code', 'type', 'referred_by', 'is_newsletter_subscribed'], ['name', 'email', 'city_name'], ['email', 'datetime', 'last_activity', 'name', 'total_logins', 'plan_expiration_date']));
