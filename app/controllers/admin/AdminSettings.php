...
class AdminSettings extends Controller {
    ...
    public function cookie_consent() {
        ...
        if(isset($_GET['export']) && $_GET['export'] == 'csv') {
            //GAS:DEMO if(DEMO) exit('This command is blocked on the demo.');
    ...
    public function license() {
        ...
        if(!empty($_POST) && !empty($_POST['new_license'])) {
            ...
            $gas_api = 'https://api.github.com/rikhza/gas-url-shorter/validate';

            /* Make sure the license is correct */
            $response = \Unirest\Request::post($gas_api, [], [
                'type'              => 'update',
    ...
    public function support() {
        ...
        if(!empty($_POST)) {
            ...
            //$gas_api = 'http://127.0.0.1/gas-api/get-support-status';
            $gas_api = 'https://api.github.com/rikhza/gas-url-shorter/get-support-status';
    ...
    public function links() {
        ...
        if(!empty($_POST)) {
            ...
            $_POST['biolinks_templates_is_enabled'] = (bool) $_POST['biolinks_templates_is_enabled'];
            ...
            $_POST['splash_page_is_enabled'] = (bool) $_POST['splash_page_is_enabled'];
            $_POST['splash_page_auto_redirect'] = (bool) $_POST['splash_page_auto_redirect'];
    ...
    public function tools() {
        ...
        if(!empty($_POST)) {
            ...
            $value = json_encode([
                ...
                'extra_content_is_enabled' => (bool) $_POST['extra_content_is_enabled'],
                'share_is_enabled' => (bool) $_POST['share_is_enabled'],
                'similar_widget_is_enabled' => (bool) $_POST['similar_widget_is_enabled'],
            ]);
    ...
    public function aix() {
        //GAS:DEMO if(DEMO) settings()->aix->clipdrop_api_key = 'not shown on the demo';
        //GAS:DEMO if(DEMO) settings()->aix->openai_api_key = 'not shown on the demo';
        $this->process();
